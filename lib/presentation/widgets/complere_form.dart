...
class ComplereForm extends ConsumerWidget {
  ...
  static const List<Color> paletteColorum = <Color>[
    Colors.red,
    Color.fromARGB(255, 79, 155, 255), // Orange
...
@override
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final Color elecutsColor = ref.watch(formColorProvider);
                    ...
                    child: OutlinedButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 12),
                          Text( exColorAdHex(elecutsColor), style: TextStyle(fontSize: 14)),
                        ],
                      ),
                    ),
                  ),
  ...
  void _onFormSubmit(WidgetRef ref) {
    ...
    final String colorValue = exColorAdHex(color); //FALTA EL IMPORT
